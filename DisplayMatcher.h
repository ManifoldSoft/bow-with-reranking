...
#ifndef __vlfeat_bow_with_reranking__DisplayMatcher__
#define __vlfeat_bow_with_reranking__DisplayMatcher__
...
#endif /* defined(__vlfeat_bow_with_reranking__DisplayMatcher__) */
